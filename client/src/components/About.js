        ...
        return(
            <div className="aboutOuter">
                <div class="row">
                    ...
                    <div class="card-panel teal">
                        <span class="white-text">
                            <h4 className="white-text">A Definition of Supply Chain Logistics</h4>
                ...
                <div class="row">
                    ...
                    <div class="card-panel teal">
                        <span class="white-text">
                            <h4 className="white-text">Customer Demands Affect Supply Chain Logistics</h4>
                ...
                <div class="row">
                    ...
                    <div class="card-panel teal">
                        <span class="white-text">
                            <h4 className="white-text">Benefits of Inventory Management in Supply Chain Logistics</h4>
